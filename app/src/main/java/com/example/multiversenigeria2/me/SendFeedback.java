...
import com.example.multiversenigeria2.databinding.ActivitySendFeedbackBinding;
...
public class SendFeedback extends AppCompatActivity {
    ...
    private void saveReport(String reportDescription) {
        ...
        documentReference = db.collection("ShareVerse").document("Admin").collection("ShareVerseSendFeedback").document();
        Map<String,Object> user = new HashMap<>();
        user.put("shareVerseFeedBack",reportDescription);
        user.put("shareVerseFeedBackUserId",currentUserId);
