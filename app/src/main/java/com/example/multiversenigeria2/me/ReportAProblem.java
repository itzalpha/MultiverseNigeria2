...
import com.example.multiversenigeria2.databinding.ActivityReportAproblemBinding;
...
public class ReportAProblem extends AppCompatActivity {
    ...
    private void saveReport(String reportDescription) {
        ...
        documentReference = db.collection("ShareVerse").document("Admin").collection("ShareVerseReportProblem").document();
        Map<String,Object> user = new HashMap<>();
        user.put("shareVerseReportDescription",reportDescription);
