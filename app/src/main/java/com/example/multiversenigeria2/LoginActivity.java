...
import com.example.multiversenigeria2.databinding.ActivityLoginBinding;
        ...
        auth.signInWithEmailAndPassword(email , password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    documentReference = db.collection("ShareVerse").document("Admin").collection("LoginSuccessFul").document(currentUserId).collection("LoginInformation").document();
                    Date date = new Date();
                    ...
                    profile.put("loginApplication" , "CampusVerse");
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                // to save user perimeter to fireStore database
                documentReference = db.collection("ShareVerse").document("Admin").collection("LoginFailed").document();
                Date date = new Date();
                SimpleDateFormat formatter = new SimpleDateFormat("dd-M-yyyy hh:mm:ss");
                String strDate = formatter.format(date);
                ...
                profile1.put("loginApplication" , "CampusVerse");
