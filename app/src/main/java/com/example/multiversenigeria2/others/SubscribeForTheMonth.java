...
import com.example.multiversenigeria2.databinding.ActivitySubscribeForTheMonthBinding;
...
public class SubscribeForTheMonth extends AppCompatActivity {
    ...
    private void subscribe() {
        ...
        documentReference1 = db.collection("ShareVerse").document("Users").collection("Buy Us Coffee").document(strDate).collection("Individuals").document(currentUserId);
        documentReference1.set(user)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        documentReference2 = db.collection("ShareVerse").document("Admin").collection("Buy Us Coffee").document("History").collection("PaidUsers").document();
